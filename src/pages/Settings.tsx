        ...
        <Tabs defaultValue="general">
          ...
          <TabsContent value="notifications" className="mt-4 space-y-4">
            <Card>
              ...
              <CardContent className="space-y-4">
                {[
                  { title: "Kullanım Limiti Uyarısı", desc: "Günlük limit aşıldığında bildirim" },
                  { title: "İzin Süresi Dolma Uyarısı", desc: "İzin süresi dolmadan önce hatırlatma" },
                  { title: "Abonelik Bitiş Uyarısı", desc: "Abonelik süresi dolmadan 7 gün önce" },
                  { title: "Sistem Uyarıları", desc: "Kritik sistem bildirimleri" },
                ].map((item, i) => (
                  <div key={i}>
                    <div className="flex items-center justify-between">
                      <div>
